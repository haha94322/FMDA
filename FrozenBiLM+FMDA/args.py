...
PRESAVE_DIR = ""
MODEL_DIR = "/media/lmy/processing/paper6_feature/result_frozenBilm/activitynet"
DATA_DIR = "/home/zhouhao/lmy/result_frozenBilm"
SSD_DIR = ""
name2folder = {
    "webvid": "WebVid",
    "lsmdc": "LSMDC",
...
"""
python videoqa.py \
--combine_datasets activitynet --combine_datasets_val activitynet --save_dir=/media/lmy/data1/lmy/result/paper6+GS/frozenbilm\
--lr=5e-5 --schedule=linear_with_warmup --load=/media/lmy/processing/paper6_feature/result_frozenBilm/MSVD/frozenbilm.pth \
...
def get_args_parser():
    ...
    parser.add_argument("--eval", default = False, help="only run evaluation")
    parser.add_argument(
        "--save_dir", default="/home/zhouhao/lmy/result/paper7/frozenbilm",
        help="path where to save, empty for no saving"
    )
    parser.add_argument("--seed", default=2018, type=int, help="random seed")
    parser.add_argument(
        "--load",
        default="/home/zhouhao/lmy/result_frozenBilm/MSVD/frozenbilm.pth",
    ...
    parser.add_argument(
        "--tgif_subtitles_path",
        default=os.path.join(DATA_DIR, name2folder["tgif"], "subtitles.pkl"),
    )
    parser.add_argument(
