...
class DebertaV2Encoder(nn.Module):
    ...
    def __init__(
        ...
        self.att = fly_1d(5)
        self.layer_number = config.num_hidden_layers
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if i > (self.layer_number - 3):     #msvd 14
                next_kv = self.att(next_kv)
...
class DebertaV2ForMaskedLM(DebertaV2PreTrainedModel):
    ...
    def forward(
        ...
        # modified = self.att(modified[-1])# + modified[-1]
        modified = modified[-1]

        prediction_scores = self.lm_predictions(modified, embeddings, bias)
