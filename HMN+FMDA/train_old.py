    ...
    for epoch in range(start_epoch, cfg.train.max_epochs):
        ...
        for i, batch in enumerate(iter(train_loader)):
            ...
            if cfg.dataset.question_type in ['action', 'transition']:
                ...
                logits_motion = logits[2].view(batch_size, -1)
                ...
                loss_motion = criterion(logits_motion, answers)
                ...
                optimizer.step()
                preds = torch.argmax(logits_all.view(batch_size, 5), dim=1)
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='./configs/tgif_qa_transition.yml', type=str)
    ...
    for i in range(30):
        ...
        # cfg.seed = 498     #0.5646   0.5706
        print(cfg.seed)
        if cfg.seed not in [498, 415, 289, 257, 76, 363]:
            continue
