...
def get_args():
    ...
    parser.add_argument(
        "--dataset_dir",
        type=str,
        default="/home/zhouhao/lmy/paper6/old/nextqa_feats/",
    ...
    parser.add_argument(
        "--checkpoint_dir", type=str, default="/home/zhouhao/lmy/result/paper7/paper6_vgt/checkpoint", help="subfolder to store checkpoint"
    )
    parser.add_argument(
        "--pretrain_path", type=str, default="/home/zhouhao/lmy/paper6/old/webvid180K/e1.pth", help="path to pretrained checkpoint"
    )
    parser.add_argument(
        "--bert_path",
        type=str,
    ...
    parser.add_argument(
        "--lr", type=float, default=0.00001, help="initial learning rate"
    )
    ...
    parser.add_argument(
        "--save_dir", type=str, default="/home/zhouhao/lmy/result/paper6_vgt/", help="path to save dir"
    )
    parser.add_argument(
        "--mc", type=int, default=5, help="number of multiple choices"
    )
    parser.add_argument(
        "--bnum", type=int, default=20, help="number of region proposal"
    )
    parser.add_argument(
        "--CM_PT", type=int, default=1, help="whether to finetune the weights pretrained on WebVid"
    )
    ...
    if args.dataset not in ["howto100m", "howtovqa"]:  # VideoQA dataset
        args.features_path = f'/home/zhouhao/lmy/paper6/old/nextqa_feats/{args.dataset}/' #os.path.join(load_path, "s3d.pth")
