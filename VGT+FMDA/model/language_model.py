...
class Bert(nn.Module):
    ...
    def __init__(self, bert_tokenizer):
        ...
        config = BertConfig.from_pretrained("/home/zhouhao/lmy/paper6/old/bert-base-uncased", output_hidden_states=True)
        self.bert = BertModel.from_pretrained("/home/zhouhao/lmy/paper6/old/bert-base-uncased", config=config)
