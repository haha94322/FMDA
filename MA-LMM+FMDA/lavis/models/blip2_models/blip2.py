...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls, truncation_side="right"):
        tokenizer = BertTokenizer.from_pretrained("/home/zhouhao/lmy/LLM/bert-base-uncased", truncation_side=truncation_side)
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2, memory_bank_length=0, num_frames=0):
        encoder_config = BertConfig.from_pretrained("/home/zhouhao/lmy/LLM/bert-base-uncased")
        ...
        Qformer = BertLMHeadModel.from_pretrained(
            "/home/zhouhao/lmy/LLM/bert-base-uncased", config=encoder_config
        )
